...
class nnUNetTrainer(object):
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        if self.local_rank == 0:
            ...
            self.print_to_log_file("Mean Validation IoU: ", metrics['foreground_mean'].get("IoU", "N/A"), also_print_to_console=True)
            self.print_to_log_file("Mean Validation HD: ", metrics['foreground_mean'].get("HD", "N/A"), also_print_to_console=True)
            self.print_to_log_file("Mean Validation Accuracy: ", metrics['foreground_mean'].get("accuracy", "N/A"), also_print_to_console=True)
            self.print_to_log_file("Mean Validation Precision: ", metrics['foreground_mean'].get("precision", "N/A"), also_print_to_console=True)
            self.print_to_log_file("Mean Validation Recall: ", metrics['foreground_mean'].get("recall", "N/A"), also_print_to_console=True)
